...
public class SaveManager
{
    ...
    public static void SaveData<T>(string name, T data)
    {
        ...
        {
            Plugin.Instance.LogError($"Unable to save key {name} to save file. GameNetworkManager is null!");
            return;
        }
    ...
    {
        if (GameNetworkManager.Instance == null) Plugin.Instance.LogError($"Unable to load key {name} from save file. GameNetworkManager is null!");
